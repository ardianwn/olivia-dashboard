<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Tambah Anggota Tim {{ $tim->nama_tim }}
        </h2>
    </x-slot>
            ...
            <div class="p-6 text-gray-900">
                <form method="POST" action="{{ route('anggota.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="scan_ktm" class="block mt-1 w-full" type="file" name="scan_ktm" required />
                        <x-input-error :messages="$errors->get('scan_ktm')" class="mt-2" />
                    </div>

                    <!-- Foto Anggota -->
                    <div class="mb-4">
                        <x-input-label for="foto_anggota" value="Foto Anggota" />
                        <x-text-input id="foto_anggota" class="block mt-1 w-full" type="file" name="foto_anggota" required />
